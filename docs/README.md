...
- [EC_Terrain_Renderer_Findings.md](EC_Terrain_Renderer_Findings.md) — the EC chunked-mesh terrain renderer: record layout, 4-stage splat recipe, vertex format, data join (from APItrace + Ghidra).
